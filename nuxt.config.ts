  ...
  nitro: {
    prerender: {
      ...
      routes: [
        ...
        '/llm.txt',
        '/og/index.svg',
        '/og/image-watermark-remover.svg',
        '/og/video-watermark-remover.svg',
        '/og/nano-banana-watermark-remover.svg',
        '/og/veo-watermark-remover.svg',
        '/og/google-flow-watermark-remover.svg',
        '/og/how-it-works.svg',
        '/og/about.svg',
        '/og/contact.svg',
        '/og/privacy-policy.svg',
        '/og/terms.svg',
        '/og/blog.svg',
        '/og/blog/google-removes-visible-gemini-watermark.svg',
        '/og/blog/how-to-remove-gemini-watermark.svg',
        '/og/blog/why-google-watermarks-gemini-images.svg',
        '/og/blog/gemini-vs-chatgpt-vs-midjourney-watermark.svg',
        '/og/blog/remove-gemini-watermark-photoshop.svg',
        '/og/blog/remove-gemini-watermark-gimp.svg',
        '/og/blog/synthid-vs-visible-watermark.svg',
        '/og/blog/gemini-watermark-chrome-extension-vs-online-tool.svg',
        '/og/blog/remove-gemini-watermark-youtube-thumbnail.svg',
        '/og/blog/remove-gemini-watermark-print-on-demand.svg',
        '/og/blog/remove-gemini-watermark-social-media.svg',
        '/og/blog/reverse-alpha-blending-explained.svg',
      ],
    },
  },
  app: {
